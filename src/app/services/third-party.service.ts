...
export class ThirdPartyService {
  ...
  async handleDropAction(sharedId: string) {
      ...
      await this.httpClient.get(`http://qa.earnwithdrop.com/partners/completions?partner_id=61&secret=${clientSecret}&shared_id=${sharedId}&status=APPROVED`).toPromise();
  }
}
